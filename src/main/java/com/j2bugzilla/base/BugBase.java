...
abstract public class BugBase
{
	 ...
	 * 
	 * @param state
	 *            a collection of String keys and String values in a
	 *            <code>HashMap</code>
	 * @throws IllegalStateException
	 *             If a required key-value pair is null
	 */
	 ...
	 * 
	 * @param alias
	 *            A {@code String} representing a unique alias for this bug.
	 */
	 ...
	 * 
	 * @param summary
	 *            A {@code String} representing the summary describing this bug.
	 */
	 ...
	 * 
	 * @param product
	 *            A {@code String} representing the product name.
	 */
	 ...
	 * 
	 * @param component
	 *            A {@code String} representing the component name.
	 */
	 ...
	 * 
	 * @param version
	 *            A {@code String} describing the version number of the product
	 ...
	 * 
	 * @param os
	 *            A {@code String} representing the operating system name.
	 */
	 ...
	 * 
	 * @param platform
	 *            A {@code String} representing the platform name.
	 */
