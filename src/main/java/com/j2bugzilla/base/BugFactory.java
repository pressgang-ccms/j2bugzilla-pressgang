...
public class BugFactory<T extends BugBase>
{
	 ...
	 * 
	 * @param properties
	 *            A {@code Map<String, Object>} describing the internal
	 *            structure of a bug.
	 ...
	 * 
	 * @param os
	 *            The operating system for a bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
	 ...
	 * 
	 * @param priority
	 *            A {@link Priority} describing the relative importance of a
	 *            bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
	 ...
	 * 
	 * @param product
	 *            A product name to associate with a bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
	 ...
	 * 
	 * @param component
	 *            A component name to associate with a bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
	 ...
	 * 
	 * @param summary
	 *            A one-line summary to describe a bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
	 ...
	 * 
	 * @param version
	 *            A version number to associate with a bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
	 ...
	 * 
	 * @param description
	 *            The description used as the initial comment on a bug.
	 * @return A reference to the original {@code BugFactory}.
	 */
