...
public class CommentBug implements BugzillaMethod
{
	 ...
	 * 
	 * @param bug
	 *            A {@code Bug} to comment on
	 * @param comment
	 *            A {@code Comment} to append
	 */
	 ...
	 * 
	 * @param id
	 *            The integer ID of an existing {@code Bug}
	 * @param comment
	 *            A {@code Comment} to append
	 */
	 ...
	 * 
	 * @param id
	 *            The integer ID of an existing <code>Bug</code>
	 * @param comment
	 *            The comment to append
	 */
